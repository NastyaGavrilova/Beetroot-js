class Circle {
  ...
  get showDiametr(spanEl) {
    return spanEl.innerHTML =  `Диаметр = ${this.radius * 2}`;
  }
...
let getDiametr = document.getElementById("<button id="js-task1-btn2">Установить радиус.</button>")
