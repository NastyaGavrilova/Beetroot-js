...
function fracReduction(obj1) {
  ...
  // for (var count = 2; i <= obj2.upNumber.value; count++) {
  //   if (
  //     obj2.upNumber.value % count === 0 &&
  //     obj2.downNumber.value % count === 0
  //   ) {
  //     (n1 = obj2.upNumber.value / count), (d1 = obj2.downNumber.value / count);
  //   }
  // }
