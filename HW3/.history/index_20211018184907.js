...
btn8.addEventListener("click", (e) => {
  ...
  let result = hour * 3600 + minutes * 60 + sec * 1;
  console.log(result);
...
let btn9 = document.getElementById("js-task9-btn");
btn9.addEventListener("click", (e) => {
  e.preventDefault();
  let task9 = document.getElementById("js-task9-input1");
  let span9 = document.getElementById("js-task9-span");
  let num9 = Number(task9.value);
  let h = Math.floor(num9 / 3600);
  let m = Math.floor((num9 % 3600) / 60);
  let s = Math.floor((num9 % 3600) % 60);

  let hDisplay = h > 0 ? h + ":" : "";
  let mDisplay = m > 0 ? m + ":" : "";
  let sDisplay = s > 0 ? s : "";

  return (span9.innerHTML = "«" + hDisplay + mDisplay + sDisplay + "»");
});

// task 10

let btn10 = document.getElementById("js-task10-btn");
btn10.addEventListener("click", (e) => {
  e.preventDefault();
  let task10 = document.getElementById("js-task10-input1");
  let task10_1 = document.getElementById("js-task10-input2");
  let task10_2 = document.getElementById("js-task10-input3");
  let task10_3 = document.getElementById("js-task10-input4");
  let task10_4 = document.getElementById("js-task10-input5");
  let task10_5 = document.getElementById("js-task10-input6");
  let span10 = document.getElementById("js-task10-span");

  let hour1 = Number(task10.value);
  let minutes1 = Number(task10_1.value);
  let sec1 = Number(task10_2.value);
  let hour2 = Number(task10_3.value);
  let minutes2 = Number(task10_4.value);
  let sec2 = Number(task10_5.value);
  let result1 = hour1 * 3600 + minutes1 * 60 + sec1;
  let result2 = hour2 * 3600 + minutes2 * 60 + sec2;
  let resulFinal = result1 - result2;

  let h1 = Math.floor(resulFinal / 3600);
  let m1 = Math.floor((resulFinal % 3600) / 60);
  let s1 = Math.floor((resulFinal % 3600) % 60);

  let hDisplay1 = h1 > 0 ? h1 + ":" : "";
  let mDisplay1 = m1 > 0 ? m1 + ":" : "";
  let sDisplay1 = s1 > 0 ? s1 : "";

  return (span10.innerHTML = "«" + hDisplay1 + mDisplay1 + sDisplay1 + "»");
});
