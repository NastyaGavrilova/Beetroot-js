...
btn.addEventListener("click", function () {
  if (redlight.classList.contains("round__red")) {
    redlight.classList.remove("round__red");
    yellowlight.classList.add("round__yellow");
  } else if (yellowlight.classList.contains("round__yellow")) {
    yellowlight.classList.remove("round__yellow");
    greenlight.classList.add("round__green");
  } else if (greenlight.classList.contains("round__green")) {
    greenlight.classList.remove("round__green");
    redlight.classList.add("round__red");
  }
});
