...
let btn3_1 = document.getElementById("js-task3-btn2");
...
let objTime = {
  ...
  showTime: function () {
    ...
    return (showInfoTime.innerHTML = `${this.hours}:${this.minutes}:${this.seconds}`);
  },
...
btn3_1.addEventListener("click", (e) => {
  e.preventDefault();
  let secTime = document.getElementById("js-task3-input1");
