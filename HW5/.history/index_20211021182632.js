...
let sumCheck = (spanEl) => {
  let res = 0;
  shopCheck.forEach(prod, i)((res += prod[i].amount * prod[i].price));

  // let r1 = shopCheck[0].amount * shopCheck[0].price;
  // let r2 = shopCheck[1].amount * shopCheck[1].price;
  // let r3 = shopCheck[2].amount * shopCheck[2].price;
  // let r4 = shopCheck[3].amount * shopCheck[3].price;
  // let r5 = shopCheck[4].amount * shopCheck[4].price;
  // res = r1 + r2 + r3 + r4 + r5;
  return (spanEl.innerHTML = res);
};
