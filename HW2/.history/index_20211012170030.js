...
for (let i = 0; i <= digits.length; i++) {
  ...
  if (digits[i] % 2 === 0 && digits[i] != 0) {
    evenCount++;
  } else if (digits[i] % 2 != 0 && digits[i] != 0) {
    oddCount++;
  }
}
console.log(digits);
console.log("Количество нулей: " + zeroCount);
console.log("Количество положительных цыфр : " + posCount);
console.log("Количество отрицательных цыфр: " + negCount);
console.log("Количество не четных цыфр: " + oddCount);
console.log("Количество четных цыфр: " + evenCount);
