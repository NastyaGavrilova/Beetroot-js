...
btn1_1.addEventListener("click", (event) => {
  ...
  const distance = getElementById("js-task1-input1");
  const averageSpeed = getElementById("js-task1-input2");
  let time = document.getElementById("js-task1-span1");
  let timeInWay = Number(distance.value) / Number(averageSpeed.value);
  let timeInRest =
