...
btn7.addEventListener("click", (e) => {
  ...
  if (task7.value != "" && task7_1.value != "" && task7_2.value != "") {
    ...
    return (span7.innerHTML = `«${task7.value}:${task7_1.value}:${zero}»`);
  } else if (task7.value != "" && task7_1.value == "" && task7_2.value != "") {
    return (span7.innerHTML = `«${task7.value}:${zero}:${task7_2.value}»`);
  } else if (task7.value == "" && task7_1.value != "" && task7_2.value != "") {
    return (span7.innerHTML = `«${zero}:${task7_1.value}:${task7_2.value}»`);
  }
});
