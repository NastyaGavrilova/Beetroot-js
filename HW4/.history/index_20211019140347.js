...
// let firstNumber = Fraction(
//   Number(firstNumerator.value),
//   Number(firstDenominator.value)
// );
// let secondNumber = Fraction(
//   Number(secondNumerator.value),
//   Number(secondDenominator.value)
// );

let firstFraction = {
  numerator: firstNumerator.value,
  denominator: secondDenominator.value,
};
let secondFraction = {
  numerator: secondNumerator.value,
  denominator: secondDenominator.value,
};
console.log(secondFraction.numerator);
function fracMiltiplicatin(obj1, obj2) {
  let multiplication = document.getElementById("js-task2-span3");
  let resultUpNumber = obj1.numerator.value * obj2.numerator.value;
  let resultDownNumber = obj1.denominator.value * obj2.denominator.value;
...
btn2.addEventListener("click", (et) => {
  et.preventDefault();
  fracMiltiplicatin(firstNumber, secondNumber);
  // subtraction();
  // multiplication();
  // devision();
